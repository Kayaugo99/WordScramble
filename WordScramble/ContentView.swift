...
struct ContentView: View {
    ...
    func addnewWord() {
        ...
        guard answer != rootWord else {
            wordError(title: "Word cannot be the starting word", message: "Use a new word, silly!")
            return
        }
        
        guard answer.count > 2 else {
            wordError(title: "Word is too short", message: "Must be longer than 3 characters")
            return
        }
